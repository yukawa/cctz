...
// Intentionally uses uint_fast8_t for several fields with an assumption that
...
// Converts Windows registry time zone data into a TZif-compatible
// ZoneInfoSource, suitable for use with the existing TimeZoneInfo parser.
